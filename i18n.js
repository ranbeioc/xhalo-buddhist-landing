(function () {
  ...
  const translations = {
    ...
    'en': {
      nav_sutras: 'Sutras',
      nav_wisdom: 'Thirteen Sutras',
      nav_practice: 'Library',
      nav_about: 'Data Guide',
    ...
    'de': {
      nav_sutras: 'Sutren',
      nav_wisdom: 'Dreizehn Sutren',
      nav_practice: 'Katalog',
      nav_about: 'Datenhinweise',
    ...
    'es': {
      nav_sutras: 'Sutras',
      nav_wisdom: 'Trece sutras',
      nav_practice: 'Catálogo',
      nav_about: 'Guía de datos',
    ...
    'fr': {
      nav_sutras: 'Sutras',
      nav_wisdom: 'Treize soutras',
      nav_practice: 'Catalogue',
      nav_about: 'Guide des données',
    ...
    'it': {
      nav_sutras: 'Sutra',
      nav_wisdom: 'Tredici sutra',
      nav_practice: 'Catalogo',
      nav_about: 'Guida ai dati',
    ...
    'pt': {
      nav_sutras: 'Sutras',
      nav_wisdom: 'Treze sutras',
      nav_practice: 'Catálogo',
      nav_about: 'Guia de dados',
    ...
    'th': {
      ...
      nav_wisdom: 'พระสูตร 13 เล่ม',
      nav_practice: 'สารบัญคัมภีร์',
      nav_about: 'คู่มือข้อมูล',
    ...
    'my': {
      ...
      nav_wisdom: 'ဗုဒ္ဓကျမ်း ၁၃ စောင်',
      nav_practice: 'ကျမ်းစာရင်း',
      nav_about: 'ဒေတာလမ်းညွှန်',
    ...
    'vi': {
      ...
      nav_wisdom: 'Mười ba kinh',
      nav_practice: 'Thư mục kinh điển',
      nav_about: 'Hướng dẫn dữ liệu',
    ...
    'km': {
      ...
      nav_wisdom: '១៣ ព្រះសូត្រ',
      nav_practice: 'បញ្ជីគម្ពីរ',
      nav_about: 'ការណែនាំទិន្នន័យ',
    ...
    'lo': {
      ...
      nav_wisdom: 'ພຣະສູດ 13 ເຫຼັ້ມ',
      nav_practice: 'ສາລະບານຄຳພີ',
      nav_about: 'ຄູ່ມືຂໍ້ມູນ',
    ...
    'id': {
      nav_sutras: 'Sutra',
      nav_wisdom: 'Tiga Belas Sutra',
      nav_practice: 'Katalog',
      nav_about: 'Informasi Data',
